...
相应的本征波函数为：
$$\begin{aligned}
    |\psi_+\rangle&=\frac{1}{\sqrt{2}}(|\psi^0_k\rangle+|\psi^0_{k'}\rangle)=\sqrt{\frac2L}\cos{\frac{n\pi x}{a}} \\
    |\psi_-\rangle&=\frac{1}{\sqrt{2}}(|\psi^0_k\rangle-|\psi^0_{k'}\rangle)=-i\sqrt{\frac2L}\sin{\frac{n\pi x}{a}} 
\end{aligned}$$
...
- 当$|E_k^0-E_{k'}^0|\gg|V_n|$时：
  $$E_{\pm}\approx\frac{E_k^0+E_{k'}^0}{2}\pm\frac{E_k^0-E_{k'}^0}{2}\left(1+\frac{2|V_n|^2}{(E_k^0-E_{k'}^0)^2}\right)\Rightarrow\begin{cases}
...
$$a_n(\vec{R}_l,\vec{r})=\frac1{\sqrt{N}}\sum_{\vec{k}}\psi_k^n(\vec{r})e^{-i\vec{k}\cdot\vec{R}_l}=\frac1{\sqrt{N}}\sum_{\vec{k}}u_k^n(\vec{r}-\vec{R}_l)e^{i\vec{k}\cdot(\vec{r}-\vec{R}_l)}$$
...
&=E_n-J(0)-2J(1)[\cos(k_xa)+\cos(k_ya)+\cos(k_za)]\\
\end{aligned}$$
...
- 带底：当$k_x=k_y=k_z=0$时：
  $$\begin{aligned}
  E_n(\vec{k})&=E_n-J(0)-2J(1)[3-\frac12(k_xa)^2-\frac12(k_ya)^2-\frac12(k_za)^2]\\
  &=E_n-J(0)-6J(1)+a^2J(1)k^2=E_{min}+a^2J(1)k^2\\
