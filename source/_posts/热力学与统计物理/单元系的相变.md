...
$$F=\begin{cases}F_0&T\geq T_c\\F_0-\frac{\alpha^2}{4\beta}&T\leq T_c\end{cases}$$
$$C=-T\frac{\partial^2 F}{\partial T^2}=\begin{cases}-T\frac{\partial^2 F_0}{\partial T^2}&T\geq T_c\\-T\frac{\partial^2 F_0}{\partial T^2}+\frac{\alpha^2}{2\beta T_c}&T\leq T_c\end{cases}$$
