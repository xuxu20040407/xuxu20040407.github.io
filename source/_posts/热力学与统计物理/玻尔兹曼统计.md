...
总的固体的内能为：
$$U=-3N\frac{\partial}{\partial\beta}\ln Z_1=\sum_{i=1}^{3N}(\frac{\hbar\omega_i}{2}+\frac{\hbar\omega_i}{e^{\beta\hbar\omega_i}-1})=\frac{\hbar\omega_i}{2}+\frac{\hbar\omega_i}{e^{\beta\hbar\omega_i}-1}$$
定容热容为：
