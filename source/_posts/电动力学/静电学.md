...
|均匀带电球体 | $\vec{E}=\dfrac{kq}{r^2}\hat{r}$ ($r>R$);$\vec{E}=\dfrac{kqr}{R^3}\hat{r}$ ($r<R$) | $V=\dfrac{kq}{r}$ ($r>R)$;$V=\dfrac{kq(3R^2-r^2)}{2R^3}$ ($r<R$) |
| 无限长带电直线 | $\vec{E}=\dfrac{\lambda}{2\pi\varepsilon_0 r}\hat{n}$ | $V=-\dfrac{\lambda}{2\pi\varepsilon_0} \ln(r/r_0)$ |
| 有限长带电直线 | $E_x=\dfrac{\lambda}{4\pi\varepsilon_0 r}(\cos\theta_2+\cos\theta_1)$;$E_y=\dfrac{\lambda}{4\pi\varepsilon_0 r}(\sin\theta_2-\sin\theta_1)$ | None|
