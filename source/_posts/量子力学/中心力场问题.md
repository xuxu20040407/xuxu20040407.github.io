...
> 当然也可以解径向方程：
> $$\frac{d^2 R}{dr^2}+\frac{2}{r}\frac{d R}{dr}+\left[\frac{2m}{\hbar^2}\left(E-\frac12m\omega^2r^2\right)-\frac{l(l+1)}{r^2} \right]R=0$$
...
## 库伦势与氢原子
当势能取为库伦势时，径向波函数方程变为：
$$\frac{d^2 R}{dr^2}+\frac{2}{r}\frac{d R}{dr}+\left[\frac{2m}{\hbar^2}\left(E+\frac{e^2}{r}\right)-\frac{l(l+1)}{r^2} \right]R=0$$
