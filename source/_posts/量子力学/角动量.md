...
1. 如果$\hat{F}$是标量算符，如$\hat{H},\hat{L^2}$，那么$[\hat{L_i},\hat{F}]=0$；
...
证明：
$\langle\hat{L_x}\rangle=\frac{1}{i\hbar}\langle[\hat{L_y},\hat{L_z}]\rangle=\frac{m}{i}\langle\hat{L_y}-\hat{L_y}\rangle=0$
...
$$\begin{aligned}\langle\hat{L_x^2}\rangle&=\frac{1}{i\hbar}\langle[\hat{L_y},\hat{L_z}]\hat{L_x}\rangle\\&=\frac{1}{i\hbar}\langle\hat{L_y}\hat{L_z}\hat{L_x}-\hat{L_z}\hat{L_y}\hat{L_x}\rangle\\&=\frac{1}{i\hbar}\langle i\hbar\hat{L_y^2}+\hat{L_y}\hat{L_x}\hat{L_z}-\hat{L_z}\hat{L_y}\hat{L_x}\rangle\\&=\langle\hat{L_y^2}\rangle\end{aligned}$$
...
2. $\hat{L_z}(\hat{L_\pm}\psi_{lm})=(\hat{L_\pm}\hat{L_z}\pm \hbar\hat{L_\pm})\psi_{lm}=(m\pm 1)\hbar\hat{L_\pm}\psi_{lm}$，这里假设$m$是本征值。
...
$$\hat{L^2}\psi_{bottom}=(\hat{L_+}\hat{L_-}+\hat{L_z^2}-\hbar\hat{L_z})\psi_{bottom}=m_{bottom}(m_{bottom}-1)\hbar^2\psi_{bottom}$$
